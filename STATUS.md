...
panel, then the art intake); same caveat each time. The self-test entry
under "Running" was re-verified 2026-08-10 by executing every suite —
that line, and only that line, carries the newer date.
